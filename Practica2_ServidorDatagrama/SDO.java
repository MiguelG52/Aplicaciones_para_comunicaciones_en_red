        ...
        try {
            ...
            while (true) {
                ...
                switch (recibido.getAccion()) {
                    case "listar" -> {
                        File carpetaServidor = new File("C:\\Users\\Migue\\Documents\\GitHub\\Aplicaciones_para_comunicaciones_en_red\\P2_java\\server");
                    ...
                    case "subir" -> {
                        ...
                        File archivo = new File("C:\\Users\\Migue\\Documents\\GitHub\\Aplicaciones_para_comunicaciones_en_red\\P2_java\\server\\" + nombreArchivo);
